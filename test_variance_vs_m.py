...
savefig('figs/test/prices.png', format='png',bbox_inches='tight')
...
legend(loc='best')
fig.set_tight_layout(True)
savefig('figs/test/variance-vs-m.png', format='png',bbox_inches='tight')
...
savefig('figs/test/success_rate-vs-m.png', format='png',bbox_inches='tight')
close(fig)
